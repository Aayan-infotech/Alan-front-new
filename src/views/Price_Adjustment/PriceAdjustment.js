          ...
          <CForm>
            <CRow className="mb-4">
              ...
              <CCol md={4}>
                ...
                <CFormSelect name="subCategory" value={filters.subCategory} onChange={handleFilterChange}>
              ...
              <CCol md={4}>
                ...
                <CFormSelect name="subSubCategory" value={filters.subSubCategory} onChange={handleFilterChange}>
