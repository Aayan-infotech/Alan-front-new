...
const SubSubCategory = () => {
  ...
  const fetchCategories = async () => {
    try {
      const { data } = await axios.get('http://18.221.196.222:7878/api/categories');
  ...
  const fetchSubCategories = (categoryId) => {
    axios
      .get(`http://18.221.196.222:7878/api/subcategory?category_id=${categoryId}`)
      .then((response) => {
  ...
  const fetchAllSubcategoriesData = async () => {
    axios.get('http://18.221.196.222:7878/api/subSubCategories')
      .then(response => {
  ...
  const handleAddSubSubCategory = () => {
    ...
    axios
      .post('http://18.221.196.222:7878/api/subSubCategories', formData, {
        headers: {
  ...
  const handleUpdateSubSubCategory = () => {
    ...
    if (subSubCategoryId) {
      axios.put(`http://18.221.196.222:7878/api/subSubCategories/${subSubCategoryId}`, payload)
        .then(() => {
  ...
  const handleDeleteSubSubCategory = (subSubCategoryToDelete) => {
    ...
    if (subSubCategoryId) {
      axios.delete(`http://18.221.196.222:7878/api/subSubCategories/${subSubCategoryId}`)
        .then(() => {
