...
const DimensionsProductDoors = () => {
  ...
  const fetchEntries = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorWidthHeight/${productIdfordet}`)
  ...
  const fetchPreHungOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorPreHungOptions/${productIdfordet}`)
  ...
  const fetchPreFinishingOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorPreFinishingOptions/${productIdfordet}`)
  ...
  const handleDeleteFinishingOption = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorPreFinishingOptions/${id}`)
  ...
  const fetchFrameOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorFrameOptions/${productIdfordet}`)
  ...
  const fetchSwingDirection = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorSwingDirection/${productIdfordet}`)
  ...
  const fetchPeepView = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorPeepView/${productIdfordet}`)
  ...
  const fetchHingeColor = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorHingeColor/${productIdfordet}`)
  ...
  const fetchFrameExtrusion = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorFrameExtrusion/${productIdfordet}`)
  ...
  const handleAddFrameExtrusion = async () => {
    ...
    setLoadingFrameExtrusion(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorFrameExtrusion', {
  ...
  const handleDeleteFrameExtrusion = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorFrameExtrusion/${id}`)
  ...
  const fetchLockOption = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorLockOption/${productIdfordet}`)
  ...
  const handleAddLockOption = async () => {
    ...
    setLoadingLockOption(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorLockOption', {
  ...
  const handleDeleteLockOption = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorLockOption/${id}`)
  ...
  const fetchDoorColor = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorColor/${productIdfordet}`)
  ...
  const handleAddDoorColor = async () => {
    ...
    setLoadingDoorColor(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorColor', {
  ...
  const handleDeleteDoorColor = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorColor/${id}`)
  ...
  const fetchWidthFrame = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorWidthFrame/${productIdfordet}`)
  ...
  const handleAddWidthFrame = async () => {
    ...
    setLoadingWidthFrame(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorWidthFrame', {
  ...
  const handleDeleteWidthFrame = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorWidthFrame/${id}`)
  ...
  const fetchJambSize = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorJambSize/${productIdfordet}`)
  ...
  const handleAddJambSize = async () => {
    ...
    setLoadingJambSize(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorJambSize', {
  ...
  const handleDeleteJambSize = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorJambSize/${id}`)
  ...
  const fetchDoorShoe = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorShoe/${productIdfordet}`)
  ...
  const handleAddDoorShoe = async () => {
    ...
    setLoadingDoorShoe(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorShoe', {
  ...
  const handleDeleteDoorShoe = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorShoe/${id}`)
  ...
  const fetchDoorWeatherstrip = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorWeatherstrip/${productIdfordet}`)
  ...
  const handleAddDoorWeatherstrip = async () => {
    ...
    setLoadingDoorWeatherstrip(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorWeatherstrip', {
  ...
  const handleDeleteDoorWeatherstrip = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorWeatherstrip/${id}`)
  ...
  const fetchDoorHinges = async () => {
    ...
    try {
      const response = await axios.get(`http://18.221.196.222:7878/api/DimDoor/DoorHinges/${productIdfordet}`)
  ...
  const handleAddDoorHinges = async () => {
    ...
    setLoadingDoorHinges(true)
    try {
      await axios.post('http://18.221.196.222:7878/api/DimDoor/DoorHinges', {
  ...
  const handleDeleteDoorHinges = async (id) => {
    try {
      await axios.delete(`http://18.221.196.222:7878/api/DimDoor/DoorHinges/${id}`)
