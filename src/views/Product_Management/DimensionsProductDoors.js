...
const DimensionsProductDoors = () => {
  ...
  const fetchEntries = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorWidthHeight/${productIdfordet}`)
  ...
  const fetchPreHungOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorPreHungOptions/${productIdfordet}`)
  ...
  const fetchPreFinishingOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorPreFinishingOptions/${productIdfordet}`)
  ...
  const fetchFrameOptions = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorFrameOptions/${productIdfordet}`)
  ...
  const fetchSwingDirection = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorSwingDirection/${productIdfordet}`)
  ...
  const fetchPeepView = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorPeepView/${productIdfordet}`)
  ...
  const fetchHingeColor = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorHingeColor/${productIdfordet}`)
  ...
  const fetchFrameExtrusion = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorFrameExtrusion/${productIdfordet}`)
  ...
  const fetchLockOption = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorLockOption/${productIdfordet}`)
  ...
  const fetchDoorColor = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorColor/${productIdfordet}`)
  ...
  const fetchWidthFrame = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorWidthFrame/${productIdfordet}`)
  ...
  const fetchJambSize = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorJambSize/${productIdfordet}`)
  ...
  const fetchDoorShoe = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorShoe/${productIdfordet}`)
  ...
  const fetchDoorWeatherstrip = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorWeatherstrip/${productIdfordet}`)
  ...
  const fetchDoorHinges = async () => {
    ...
    try {
      const response = await axios.get(`http://44.196.64.110:7878/api/DimDoor/DoorHinges/${productIdfordet}`)
